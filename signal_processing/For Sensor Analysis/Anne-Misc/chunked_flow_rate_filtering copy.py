...
def get_rolling_slope(csv_data, datapnt_delay=None):
    window_width_raw = 60 #200
    window_width_flowrate = 60
    cutoff_1 = 0.1 # 0.02
    order_1 = 6 # 12  # original: 3
    if datapnt_delay is None:
...
csv_name_30_light1 = r'load_2digit_4_avg20_delay5s.csv'
csv_name_30_light2 = r'load_2digit_3_avg20.csv'
csv_name_30_light3 = r'load_2digit_2_normal.csv'
...
csv_data_30_light2 = process_csv(csv_path_30_light2)[100:]# [3000:]
...
# flow_rate_light1 = get_rolling_slope(csv_data_30_light1, 5097)
flow_rate_light2 = get_rolling_slope(csv_data_30_light2, 1797)
# flow_rate_light3 = get_rolling_slope(csv_data_30_light3, 90)
