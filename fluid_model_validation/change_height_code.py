...
rho = 1030            # density of milk (kg/m^3)-----> CHANGE
l_total = 0.7         # total length of tube (m)------> CHANGE
mu = 0.0034           # viscosity of milk (Pa*s) -----> CHANGE
h_full = 0.07         # height of fluid in syringe (m) -----> CHANGE
h_half_full = 0.035   # height of half fluid in syringe (m) -----> CHANGE
...
p2 = p0+rho*g*h_diff  # pressure in baby's stomach (Pa)
